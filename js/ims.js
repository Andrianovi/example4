window.addEventListener('load', function () {
	...
	let slide1Img = document.getElementById('slide1-img');
	slide1Img.innerHTML = `<source srcset="img/slide1.webp" type="image/webp" loading="eager">
<img src="img/slide1.png" alt="" loading="eager" />`;
